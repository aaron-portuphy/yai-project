...
import logo from '../assets/images/ecofarms_logo.png'
        ...
        <div className="container-xxl">
            <div className="row align-items-center">
                ...
                <div className="col-6 d-flex justify-content-between">
                    <div>
                     <a href="tel:+233555747276">Call us at +233555747276</a>
                    </div>
                    <div>
        ...
        <div className="container-xxl">
            <div className="row">
                <div className="col-2 m-auto text-center">
                    <Link to='/'><img src={logo} alt="Ecofarms Logo" className="img-fluid logo" /></Link> 
                </div> 
                <div className="col-3 d-flex align-items-center mt-3">
                    <div className="input-group mb-3">
                        {/* <span className="input-group-text" id="basic-addon1">All</span> */}
                        <input type="text" className="form-control p-2" placeholder="Search products" aria-label="Recipent" />
